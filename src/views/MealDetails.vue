<template>
    <div class="max-w-[800px] mx-auto p-8 text-yellow-400">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2">
            <div>
                <h2 class="text-2xl font-semibold mb-3">Ingrediants</h2>
                <ul>
        ...
        <div class="mt-4 flex justify-center">
            ...
            <a 
                href="meal.strSource" 
                target="_blank" 
                class="ml-3 px-3 py-2 rounded border-2 border-indigo-600 bg-indigo-600 hover:text-white transition-colors"
                >
